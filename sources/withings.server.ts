...
export const WithingsSleepSummarySeries = proxyCollection<
  Withings.SleepSummarySeries & { _withings_userId: string; _io_userId: string, startedAt: Date; endedAt: Date }
>("withings_sleep_summary_series");
export const WithingsMeasureGroup = proxyCollection<
  Withings.MeasureGroup & { _withings_userId: string; _io_userId: string }
