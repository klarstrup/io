...
export function DiaryAgendaDayDay({
  ...
  return (
    <>
      <div
        className="mx-auto mt-1 -mb-px flex max-w-lg xl:w-[24rem] items-center gap-1 pr-2 leading-normal"
        style={{
          textShadow:
      ...
      <FieldSetX
        ...
        className={
          ...
          "mx-auto mb-1 flex max-w-lg xl:w-[24rem] flex-0! flex-col items-stretch gap-1.5 pr-1 pb-1 pl-0 " +
