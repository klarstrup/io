...
export default function UserStuff() {
  ...
  return (
    <div
      className="fixed left-1/2 z-50 lg:z-0 flex max-w-[calc(100%-2.5rem)] -translate-x-1/2 transform items-center gap-x-2 overflow-hidden rounded-2xl border border-[yellow]/25 bg-white/10 py-0.5 pr-0 pl-2 backdrop-blur-md sm:gap-2 pointer-coarse:bottom-2 pointer-fine:top-4"
      style={{
        boxShadow:
