...
export type DiaryAgendaDayDayBacklogTodosQuery = { user: { __typename: 'User', id: string, todos: Array<{ __typename: 'Todo', id: string, created: Date | null, due: Date | null, completed: Date | null, summary: string | null }> | null } | null };
...
export type ListPageUserQuery = { user: { __typename: 'User', id: string, todos: Array<{ __typename: 'Todo', id: string, created: Date | null, due: Date | null, completed: Date | null, summary: string | null }> | null } | null };
