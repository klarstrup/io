...
export type CreateWorkoutDataExercisesInput = {
  comment?: string | null | undefined;
  displayName?: string | null | undefined;
  exerciseId: number;
  sets: Array<CreateWorkoutDataWorkoutSetInput>;
};

export type CreateWorkoutDataInput = {
  exercises: Array<CreateWorkoutDataExercisesInput>;
  locationId?: string | null | undefined;
  source?: string | null | undefined;
  workedOutAt: Date;
};

export type CreateWorkoutDataWorkoutSetInput = {
  comment?: string | null | undefined;
  createdAt?: Date | null | undefined;
  inputs: Array<CreateWorkoutDataWorkoutSetInputInput>;
  meta?: Array<CreateWorkoutDataWorkoutSetMetaInput> | null | undefined;
  updatedAt?: Date | null | undefined;
};

export type CreateWorkoutDataWorkoutSetInputInput = {
  assistType?: string | null | undefined;
  unit?: string | null | undefined;
  value?: number | null | undefined;
};

export type CreateWorkoutDataWorkoutSetMetaInput = {
  key: string;
  value: string;
};
...
export type SnoozeExerciseScheduleInput = {
  exerciseScheduleId: string | number;
...
export type UpdateWorkoutDataExercisesInput = {
  comment?: string | null | undefined;
  displayName?: string | null | undefined;
  exerciseId: number;
  sets: Array<UpdateWorkoutDataWorkoutSetInput>;
};

export type UpdateWorkoutDataInput = {
  exercises: Array<UpdateWorkoutDataExercisesInput>;
  locationId?: string | null | undefined;
  source?: string | null | undefined;
  workedOutAt?: Date | null | undefined;
};

export type UpdateWorkoutDataWorkoutSetInput = {
  comment?: string | null | undefined;
  createdAt?: Date | null | undefined;
  inputs: Array<UpdateWorkoutDataWorkoutSetInputInput>;
  meta?: Array<UpdateWorkoutDataWorkoutSetMetaInput> | null | undefined;
  updatedAt?: Date | null | undefined;
};

export type UpdateWorkoutDataWorkoutSetInputInput = {
  assistType?: string | null | undefined;
  unit?: string | null | undefined;
  value?: number | null | undefined;
};

export type UpdateWorkoutDataWorkoutSetMetaInput = {
  key: string;
  value: string;
};
...
export type UpdateWorkoutWorkedOutAtDataInput = {
  workedOutAt: Date;
};

export type UpdateWorkoutWorkedOutAtInput = {
...
export type DiaryAgendaDayUserTodosQuery = { user: { __typename: 'User', id: string, name: string, email: string | null, image: string, emailVerified: boolean | null, timeZone: string | null, locations: Array<{ __typename: 'Location', id: string, createdAt: Date, updatedAt: Date, name: string, userId: string, knownAddresses: Array<string> | null, boulderCircuits: Array<{ __typename: 'BoulderCircuit', id: string, holdColor: string | null, gradeEstimate: number | null, gradeRange: Array<number | null> | null, name: string, labelColor: string | null, hasZones: boolean | null, description: string | null, createdAt: Date, updatedAt: Date }> | null }> | null, journalEntries: { __typename: 'JournalEntriesConnection', pageInfo: { __typename: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean, startCursor: string | null, endCursor: string | null }, nodes: Array<
        ...
        | { __typename: 'Event', id: string, created: Date | null, summary: string | null, start: Date, end: Date, datetype: string, location: string | null, url: string | null }
...
export type CreateTodoMutation = { createTodo: { __typename: 'CreateTodoPayload', todo: { __typename: 'Todo', id: string, created: Date | null, summary: string | null, due: Date | null, completed: Date | null } | null } | null };

export type DiaryAgendaDayDayBacklogTodosQueryVariables = Exact<{ [key: string]: never; }>;


export type DiaryAgendaDayDayBacklogTodosQuery = { user: { __typename: 'User', id: string, timeZone: string | null, todos: Array<{ __typename: 'Todo', id: string, created: Date | null, due: Date | null, completed: Date | null, summary: string | null }> | null } | null };
...
export type SnoozeExerciseScheduleMutation = { snoozeExerciseSchedule: { __typename: 'SnoozeExerciseSchedulePayload', exerciseSchedule: { __typename: 'ExerciseSchedule', id: string, exerciseId: number, enabled: boolean, increment: number | null, workingSets: number | null, workingReps: number | null, deloadFactor: number | null, baseWeight: number | null, snoozedUntil: Date | null, frequency: { __typename: 'Duration', years: number | null, months: number | null, weeks: number | null, days: number | null, hours: number | null, minutes: number | null, seconds: number | null }, nextSet: { __typename: 'NextSet', id: string, lastWorkedOutAt: Date | null, dueOn: Date, exerciseId: number, successful: boolean | null, nextWorkingSets: number | null, nextWorkingSetInputs: Array<{ __typename: 'WorkoutSetInput', unit: string | null, value: number | null, assistType: string | null }> | null, exerciseSchedule: { __typename: 'ExerciseSchedule', id: string, exerciseId: number, enabled: boolean, increment: number | null, workingSets: number | null, workingReps: number | null, deloadFactor: number | null, baseWeight: number | null, snoozedUntil: Date | null, frequency: { __typename: 'Duration', years: number | null, months: number | null, weeks: number | null, days: number | null, hours: number | null, minutes: number | null, seconds: number | null } } } | null } | null } | null };
...
export type UnsnoozeExerciseScheduleMutation = { unsnoozeExerciseSchedule: { __typename: 'UnsnoozeExerciseSchedulePayload', exerciseSchedule: { __typename: 'ExerciseSchedule', id: string, exerciseId: number, enabled: boolean, increment: number | null, workingSets: number | null, workingReps: number | null, deloadFactor: number | null, baseWeight: number | null, snoozedUntil: Date | null, frequency: { __typename: 'Duration', years: number | null, months: number | null, weeks: number | null, days: number | null, hours: number | null, minutes: number | null, seconds: number | null }, nextSet: { __typename: 'NextSet', id: string, lastWorkedOutAt: Date | null, dueOn: Date, exerciseId: number, successful: boolean | null, nextWorkingSets: number | null, nextWorkingSetInputs: Array<{ __typename: 'WorkoutSetInput', unit: string | null, value: number | null, assistType: string | null }> | null, exerciseSchedule: { __typename: 'ExerciseSchedule', id: string, exerciseId: number, enabled: boolean, increment: number | null, workingSets: number | null, workingReps: number | null, deloadFactor: number | null, baseWeight: number | null, snoozedUntil: Date | null, frequency: { __typename: 'Duration', years: number | null, months: number | null, weeks: number | null, days: number | null, hours: number | null, minutes: number | null, seconds: number | null } } } | null } | null } | null };

export type DiaryAgendaDayTodoFragment = { __typename: 'Todo', id: string, created: Date | null, due: Date | null, completed: Date | null, summary: string | null } & { ' $fragmentName'?: 'DiaryAgendaDayTodoFragment' };
...
export type UpdateTodoMutation = { updateTodo: { __typename: 'UpdateTodoPayload', todo: { __typename: 'Todo', id: string, created: Date | null, due: Date | null, completed: Date | null, summary: string | null } | null } | null };
...
export type GetWorkoutQuery = { user: { __typename: 'User', id: string, workout: { __typename: 'Workout', id: string, createdAt: Date, updatedAt: Date, workedOutAt: Date, materializedAt: Date | null, locationId: string | null, source: string | null, exercises: Array<{ __typename: 'WorkoutExercise', exerciseId: number, displayName: string | null, comment: string | null, exerciseInfo: { __typename: 'ExerciseInfo', id: number, aliases: Array<string>, name: string, isHidden: boolean, inputs: Array<{ __typename: 'ExerciseInfoInput', type: string, options: Array<{ __typename: 'WorkoutSetInputOption', value: string | null }> | null }>, instructions: Array<{ __typename: 'ExerciseInfoInstruction', value: string }>, tags: Array<{ __typename: 'ExerciseInfoTag', name: string, type: string }> | null }, sets: Array<{ __typename: 'WorkoutSet', comment: string | null, createdAt: Date | null, updatedAt: Date | null, inputs: Array<{ __typename: 'WorkoutSetInput', unit: string | null, value: number | null, assistType: string | null }>, meta: Array<{ __typename: 'WorkoutSetMeta', key: string, value: string }> | null }> }> } | null } | null };

export type ListPageUserQueryVariables = Exact<{ [key: string]: never; }>;


export type ListPageUserQuery = { user: { __typename: 'User', id: string, timeZone: string | null, todos: Array<{ __typename: 'Todo', id: string, created: Date | null, due: Date | null, completed: Date | null, summary: string | null }> | null } | null };

export type SourceWidgetQueryVariables = Exact<{ [key: string]: never; }>;


export type SourceWidgetQuery = { user: { __typename: 'User', id: string, dataSources: Array<{ __typename: 'UserDataSource', id: string, name: string, paused: boolean | null, createdAt: Date, updatedAt: Date, lastSyncedAt: Date | null, lastSuccessfulAt: Date | null, lastSuccessfulRuntime: number | null, lastResult: string | null, lastFailedAt: Date | null, lastFailedRuntime: number | null, lastAttemptedAt: Date | null, lastError: string | null, source: string, config: unknown }> | null } | null };
...
export const DiaryAgendaDayUserTodosDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"DiaryAgendaDayUserTodos"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"after"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"before"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"on"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"email"}},{"kind":"Field","name":{"kind":"Name","value":"image"}},{"kind":"Field","name":{"kind":"Name","value":"emailVerified"}},{"kind":"Field","name":{"kind":"Name","value":"timeZone"}},{"kind":"Field","name":{"kind":"Name","value":"locations"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"userId"}},{"kind":"Field","name":{"kind":"Name","value":"knownAddresses"}},{"kind":"Field","name":{"kind":"Name","value":"boulderCircuits"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"holdColor"}},{"kind":"Field","name":{"kind":"Name","value":"gradeEstimate"}},{"kind":"Field","name":{"kind":"Name","value":"gradeRange"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"labelColor"}},{"kind":"Field","name":{"kind":"Name","value":"hasZones"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"journalEntries"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"after"},"value":{"kind":"Variable","name":{"kind":"Name","value":"after"}}},{"kind":"Argument","name":{"kind":"Name","value":"before"},"value":{"kind":"Variable","name":{"kind":"Name","value":"before"}}},{"kind":"Argument","name":{"kind":"Name","value":"on"},"value":{"kind":"Variable","name":{"kind":"Name","value":"on"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"__typename"}},{"kind":"Field","name":{"kind":"Name","value":"pageInfo"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"hasNextPage"}},{"kind":"Field","name":{"kind":"Name","value":"hasPreviousPage"}},{"kind":"Field","name":{"kind":"Name","value":"startCursor"}},{"kind":"Field","name":{"kind":"Name","value":"endCursor"}}]}},{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"__typename"}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Delivery"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"timestamp"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"from"}},{"kind":"Field","name":{"kind":"Name","value":"url"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Meal"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"datetime"}},{"kind":"Field","name":{"kind":"Name","value":"url"}},{"kind":"Field","name":{"kind":"Name","value":"foodEntries"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"datetime"}},{"kind":"Field","name":{"kind":"Name","value":"food"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"description"}}]}}]}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Sleep"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"startedAt"}},{"kind":"Field","name":{"kind":"Name","value":"endedAt"}},{"kind":"Field","name":{"kind":"Name","value":"totalSleepTime"}},{"kind":"Field","name":{"kind":"Name","value":"deviceId"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"NextSet"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"lastWorkedOutAt"}},{"kind":"Field","name":{"kind":"Name","value":"dueOn"}},{"kind":"Field","name":{"kind":"Name","value":"exerciseId"}},{"kind":"Field","name":{"kind":"Name","value":"successful"}},{"kind":"Field","name":{"kind":"Name","value":"nextWorkingSets"}},{"kind":"Field","name":{"kind":"Name","value":"nextWorkingSetInputs"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"unit"}},{"kind":"Field","name":{"kind":"Name","value":"value"}},{"kind":"Field","name":{"kind":"Name","value":"assistType"}}]}},{"kind":"Field","name":{"kind":"Name","value":"exerciseSchedule"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"exerciseId"}},{"kind":"Field","name":{"kind":"Name","value":"exerciseInfo"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"aliases"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"isHidden"}},{"kind":"Field","name":{"kind":"Name","value":"inputs"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"options"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"value"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"instructions"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"value"}}]}},{"kind":"Field","name":{"kind":"Name","value":"tags"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"type"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"enabled"}},{"kind":"Field","name":{"kind":"Name","value":"frequency"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"years"}},{"kind":"Field","name":{"kind":"Name","value":"months"}},{"kind":"Field","name":{"kind":"Name","value":"weeks"}},{"kind":"Field","name":{"kind":"Name","value":"days"}},{"kind":"Field","name":{"kind":"Name","value":"hours"}},{"kind":"Field","name":{"kind":"Name","value":"minutes"}},{"kind":"Field","name":{"kind":"Name","value":"seconds"}}]}},{"kind":"Field","name":{"kind":"Name","value":"increment"}},{"kind":"Field","name":{"kind":"Name","value":"workingSets"}},{"kind":"Field","name":{"kind":"Name","value":"workingReps"}},{"kind":"Field","name":{"kind":"Name","value":"deloadFactor"}},{"kind":"Field","name":{"kind":"Name","value":"baseWeight"}},{"kind":"Field","name":{"kind":"Name","value":"snoozedUntil"}}]}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Todo"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"created"}},{"kind":"Field","name":{"kind":"Name","value":"summary"}},{"kind":"Field","name":{"kind":"Name","value":"due"}},{"kind":"Field","name":{"kind":"Name","value":"completed"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Trip"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"start"}},{"kind":"Field","name":{"kind":"Name","value":"end"}},{"kind":"Field","name":{"kind":"Name","value":"legs"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"start"}},{"kind":"Field","name":{"kind":"Name","value":"end"}},{"kind":"Field","name":{"kind":"Name","value":"from"}},{"kind":"Field","name":{"kind":"Name","value":"to"}},{"kind":"Field","name":{"kind":"Name","value":"mode"}}]}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Event"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"created"}},{"kind":"Field","name":{"kind":"Name","value":"summary"}},{"kind":"Field","name":{"kind":"Name","value":"start"}},{"kind":"Field","name":{"kind":"Name","value":"end"}},{"kind":"Field","name":{"kind":"Name","value":"datetype"}},{"kind":"Field","name":{"kind":"Name","value":"location"}},{"kind":"Field","name":{"kind":"Name","value":"url"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Workout"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"workedOutAt"}},{"kind":"Field","name":{"kind":"Name","value":"materializedAt"}},{"kind":"Field","name":{"kind":"Name","value":"locationId"}},{"kind":"Field","name":{"kind":"Name","value":"source"}},{"kind":"Field","name":{"kind":"Name","value":"exercises"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"exerciseId"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"comment"}},{"kind":"Field","name":{"kind":"Name","value":"exerciseInfo"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"aliases"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"isHidden"}},{"kind":"Field","name":{"kind":"Name","value":"inputs"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"options"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"value"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"instructions"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"value"}}]}},{"kind":"Field","name":{"kind":"Name","value":"tags"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"type"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"sets"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"comment"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"inputs"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"unit"}},{"kind":"Field","name":{"kind":"Name","value":"value"}},{"kind":"Field","name":{"kind":"Name","value":"assistType"}}]}},{"kind":"Field","name":{"kind":"Name","value":"meta"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"key"}},{"kind":"Field","name":{"kind":"Name","value":"value"}}]}}]}}]}}]}}]}}]}}]}}]}}]} as unknown as DocumentNode<DiaryAgendaDayUserTodosQuery, DiaryAgendaDayUserTodosQueryVariables>;
...
export const DiaryAgendaDayDayBacklogTodosDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"DiaryAgendaDayDayBacklogTodos"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"timeZone"}},{"kind":"Field","name":{"kind":"Name","value":"todos"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"created"}},{"kind":"Field","name":{"kind":"Name","value":"due"}},{"kind":"Field","name":{"kind":"Name","value":"completed"}},{"kind":"Field","name":{"kind":"Name","value":"summary"}}]}}]}}]}}]} as unknown as DocumentNode<DiaryAgendaDayDayBacklogTodosQuery, DiaryAgendaDayDayBacklogTodosQueryVariables>;
...
export type GQDelivery = GQJournalEntry & {
  __typename: 'Delivery';
...
export type GQEvent = GQJournalEntry & {
  __typename: 'Event';
...
export type GQExerciseInfoInput = {
  ...
  options?: Maybe<Array<GQWorkoutSetInputOption>>;
...
export type GQFood = {
  ...
  id: Scalars['ID']['output'];
  servingSizes?: Maybe<Array<GQServingSize>>;
};
...
export type GQFoodEntry = {
  ...
  nutritionalContents?: Maybe<GQNutritionalContents>;
  servingSize?: Maybe<GQServingSize>;
...
export type GQJournalEntriesConnection = {
  __typename: 'JournalEntriesConnection';
  nodes: Array<GQJournalEntryUnion>;
  pageInfo: GQPageInfo;
};

export type GQJournalEntry = {
  id: Scalars['ID']['output'];
};

export type GQJournalEntryUnion = GQDelivery | GQEvent | GQMeal | GQNextSet | GQSleep | GQTodo | GQTrip | GQWorkout;
...
export type GQMeal = GQJournalEntry & {
  __typename: 'Meal';
  datetime: Scalars['Date']['output'];
  foodEntries: Array<GQFoodEntry>;
  id: Scalars['ID']['output'];
  mealName?: Maybe<Scalars['String']['output']>;
  type?: Maybe<Scalars['String']['output']>;
  url?: Maybe<Scalars['String']['output']>;
...
export type GQNextSet = GQJournalEntry & {
  ...
  id: Scalars['ID']['output'];
  lastWorkedOutAt?: Maybe<Scalars['Date']['output']>;
...
export type GQTodo = GQJournalEntry & {
  __typename: 'Todo';
...
export type GQTrip = GQJournalEntry & {
  __typename: 'Trip';
  end: Scalars['Date']['output'];
  id: Scalars['ID']['output'];
  legs: Array<GQTripLeg>;
  start: Scalars['Date']['output'];
};

export type GQTripLeg = {
  __typename: 'TripLeg';
  end: Scalars['Date']['output'];
  from: Scalars['String']['output'];
...
export type GQUserJournalEntriesArgs = {
...
export type GQUserNextSetsArgs = {
  ...
  exerciseIds?: InputMaybe<Array<Scalars['Int']['input']>>;
};
...
export type GQWorkout = GQJournalEntry & {
  __typename: 'Workout';
  createdAt: Scalars['Date']['output'];
...
export type GQWorkoutSetInputOption = {
...
export type GQResolversUnionTypes<_RefType extends Record<string, unknown>> = {
  JournalEntryUnion:
    | ( GQDelivery )
    | ( GQEvent )
    | ( GQMeal )
...
export type GQResolversInterfaceTypes<_RefType extends Record<string, unknown>> = {
  JournalEntry:
    | ( GQDelivery )
    | ( GQEvent )
    | ( GQMeal )
...
export type GQResolversTypes = {
  ...
  Delivery: ResolverTypeWrapper<GQDelivery>;
  ...
  JournalEntriesConnection: ResolverTypeWrapper<Omit<GQJournalEntriesConnection, 'nodes'> & { nodes: Array<GQResolversTypes['JournalEntryUnion']> }>;
  JournalEntry: ResolverTypeWrapper<GQResolversInterfaceTypes<GQResolversTypes>['JournalEntry']>;
  JournalEntryUnion: ResolverTypeWrapper<GQResolversUnionTypes<GQResolversTypes>['JournalEntryUnion']>;
  Location: ResolverTypeWrapper<GQLocation>;
  Meal: ResolverTypeWrapper<GQMeal>;
  Mutation: ResolverTypeWrapper<Record<PropertyKey, never>>;
  NextSet: ResolverTypeWrapper<GQNextSet>;
  NutritionalContents: ResolverTypeWrapper<GQNutritionalContents>;
  PageInfo: ResolverTypeWrapper<GQPageInfo>;
  ...
  Trip: ResolverTypeWrapper<GQTrip>;
  TripLeg: ResolverTypeWrapper<GQTripLeg>;
  ...
  User: ResolverTypeWrapper<Omit<GQUser, 'journalEntries'> & { journalEntries: GQResolversTypes['JournalEntriesConnection'] }>;
  ...
  WorkoutSetInputOption: ResolverTypeWrapper<GQWorkoutSetInputOption>;
...
export type GQResolversParentTypes = {
  ...
  JournalEntriesConnection: Omit<GQJournalEntriesConnection, 'nodes'> & { nodes: Array<GQResolversParentTypes['JournalEntryUnion']> };
  JournalEntry: GQResolversInterfaceTypes<GQResolversParentTypes>['JournalEntry'];
  JournalEntryUnion: GQResolversUnionTypes<GQResolversParentTypes>['JournalEntryUnion'];
  Location: GQLocation;
  Meal: GQMeal;
  ...
  UpdateWorkoutWorkedOutAtDataInput: GQUpdateWorkoutWorkedOutAtDataInput;
  UpdateWorkoutWorkedOutAtInput: GQUpdateWorkoutWorkedOutAtInput;
  User: Omit<GQUser, 'journalEntries'> & { journalEntries: GQResolversParentTypes['JournalEntriesConnection'] };
  UserDataSource: GQUserDataSource;
  Workout: GQWorkout;
  WorkoutExercise: GQWorkoutExercise;
  WorkoutSet: GQWorkoutSet;
  WorkoutSetInput: GQWorkoutSetInput;
  WorkoutSetInputOption: GQWorkoutSetInputOption;
...
export type GQDeliveryResolvers<ContextType = any, ParentType extends GQResolversParentTypes['Delivery'] = GQResolversParentTypes['Delivery']> = {
  from?: Resolver<GQResolversTypes['String'], ParentType, ContextType>;
  id?: Resolver<GQResolversTypes['ID'], ParentType, ContextType>;
  ...
  url?: Resolver<Maybe<GQResolversTypes['String']>, ParentType, ContextType>;
...
export type GQExerciseInfoInputResolvers<ContextType = any, ParentType extends GQResolversParentTypes['ExerciseInfoInput'] = GQResolversParentTypes['ExerciseInfoInput']> = {
  options?: Resolver<Maybe<Array<GQResolversTypes['WorkoutSetInputOption']>>, ParentType, ContextType>;
...
export type GQFoodResolvers<ContextType = any, ParentType extends GQResolversParentTypes['Food'] = GQResolversParentTypes['Food']> = {
  ...
  id?: Resolver<GQResolversTypes['ID'], ParentType, ContextType>;
  servingSizes?: Resolver<Maybe<Array<GQResolversTypes['ServingSize']>>, ParentType, ContextType>;
};
...
export type GQFoodEntryResolvers<ContextType = any, ParentType extends GQResolversParentTypes['FoodEntry'] = GQResolversParentTypes['FoodEntry']> = {
  ...
  id?: Resolver<GQResolversTypes['ID'], ParentType, ContextType>;
  mealName?: Resolver<Maybe<GQResolversTypes['String']>, ParentType, ContextType>;
  nutritionalContents?: Resolver<Maybe<GQResolversTypes['NutritionalContents']>, ParentType, ContextType>;
  servingSize?: Resolver<Maybe<GQResolversTypes['ServingSize']>, ParentType, ContextType>;
  servings?: Resolver<Maybe<GQResolversTypes['Float']>, ParentType, ContextType>;
...
export type GQJournalEntriesConnectionResolvers<ContextType = any, ParentType extends GQResolversParentTypes['JournalEntriesConnection'] = GQResolversParentTypes['JournalEntriesConnection']> = {
  nodes?: Resolver<Array<GQResolversTypes['JournalEntryUnion']>, ParentType, ContextType>;
  pageInfo?: Resolver<GQResolversTypes['PageInfo'], ParentType, ContextType>;
};

export type GQJournalEntryResolvers<ContextType = any, ParentType extends GQResolversParentTypes['JournalEntry'] = GQResolversParentTypes['JournalEntry']> = {
  __resolveType: TypeResolveFn<'Delivery' | 'Event' | 'Meal' | 'NextSet' | 'Sleep' | 'Todo' | 'Trip' | 'Workout', ParentType, ContextType>;
};

export type GQJournalEntryUnionResolvers<ContextType = any, ParentType extends GQResolversParentTypes['JournalEntryUnion'] = GQResolversParentTypes['JournalEntryUnion']> = {
  __resolveType: TypeResolveFn<'Delivery' | 'Event' | 'Meal' | 'NextSet' | 'Sleep' | 'Todo' | 'Trip' | 'Workout', ParentType, ContextType>;
};
...
export type GQMealResolvers<ContextType = any, ParentType extends GQResolversParentTypes['Meal'] = GQResolversParentTypes['Meal']> = {
  datetime?: Resolver<GQResolversTypes['Date'], ParentType, ContextType>;
  foodEntries?: Resolver<Array<GQResolversTypes['FoodEntry']>, ParentType, ContextType>;
  id?: Resolver<GQResolversTypes['ID'], ParentType, ContextType>;
  mealName?: Resolver<Maybe<GQResolversTypes['String']>, ParentType, ContextType>;
  type?: Resolver<Maybe<GQResolversTypes['String']>, ParentType, ContextType>;
  url?: Resolver<Maybe<GQResolversTypes['String']>, ParentType, ContextType>;
...
export type GQNextSetResolvers<ContextType = any, ParentType extends GQResolversParentTypes['NextSet'] = GQResolversParentTypes['NextSet']> = {
  ...
  id?: Resolver<GQResolversTypes['ID'], ParentType, ContextType>;
  lastWorkedOutAt?: Resolver<Maybe<GQResolversTypes['Date']>, ParentType, ContextType>;
...
export type GQPageInfoResolvers<ContextType = any, ParentType extends GQResolversParentTypes['PageInfo'] = GQResolversParentTypes['PageInfo']> = {
  endCursor?: Resolver<Maybe<GQResolversTypes['String']>, ParentType, ContextType>;
  hasNextPage?: Resolver<GQResolversTypes['Boolean'], ParentType, ContextType>;
  hasPreviousPage?: Resolver<GQResolversTypes['Boolean'], ParentType, ContextType>;
  startCursor?: Resolver<Maybe<GQResolversTypes['String']>, ParentType, ContextType>;
};
...
export type GQTripResolvers<ContextType = any, ParentType extends GQResolversParentTypes['Trip'] = GQResolversParentTypes['Trip']> = {
  end?: Resolver<GQResolversTypes['Date'], ParentType, ContextType>;
  id?: Resolver<GQResolversTypes['ID'], ParentType, ContextType>;
  legs?: Resolver<Array<GQResolversTypes['TripLeg']>, ParentType, ContextType>;
  start?: Resolver<GQResolversTypes['Date'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type GQTripLegResolvers<ContextType = any, ParentType extends GQResolversParentTypes['TripLeg'] = GQResolversParentTypes['TripLeg']> = {
  end?: Resolver<GQResolversTypes['Date'], ParentType, ContextType>;
  from?: Resolver<GQResolversTypes['String'], ParentType, ContextType>;
  mode?: Resolver<GQResolversTypes['String'], ParentType, ContextType>;
  start?: Resolver<GQResolversTypes['Date'], ParentType, ContextType>;
  to?: Resolver<GQResolversTypes['String'], ParentType, ContextType>;
};
...
export type GQUserResolvers<ContextType = any, ParentType extends GQResolversParentTypes['User'] = GQResolversParentTypes['User']> = {
  ...
  trips?: Resolver<Maybe<Array<GQResolversTypes['Trip']>>, ParentType, ContextType>;
...
export type GQWorkoutSetInputOptionResolvers<ContextType = any, ParentType extends GQResolversParentTypes['WorkoutSetInputOption'] = GQResolversParentTypes['WorkoutSetInputOption']> = {
  value?: Resolver<Maybe<GQResolversTypes['String']>, ParentType, ContextType>;
};
...
export type GQResolvers<ContextType = any> = {
  ...
  Delivery?: GQDeliveryResolvers<ContextType>;
  ...
  JournalEntriesConnection?: GQJournalEntriesConnectionResolvers<ContextType>;
  JournalEntry?: GQJournalEntryResolvers<ContextType>;
  JournalEntryUnion?: GQJournalEntryUnionResolvers<ContextType>;
  Location?: GQLocationResolvers<ContextType>;
  Meal?: GQMealResolvers<ContextType>;
  ...
  PageInfo?: GQPageInfoResolvers<ContextType>;
  ...
  Trip?: GQTripResolvers<ContextType>;
  TripLeg?: GQTripLegResolvers<ContextType>;
  ...
  WorkoutSetInputOption?: GQWorkoutSetInputOptionResolvers<ContextType>;
