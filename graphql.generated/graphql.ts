...
export type GQJournalEntryUnion = GQEvent | GQNextSet | GQSleep | GQTodo | GQWorkout;
...
export type GQJournalEntryResolvers<ContextType = any, ParentType extends GQResolversParentTypes['JournalEntry'] = GQResolversParentTypes['JournalEntry']> = {
  __resolveType: TypeResolveFn<'Event' | 'NextSet' | 'Sleep' | 'Todo' | 'Workout', ParentType, ContextType>;
};
