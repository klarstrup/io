...
export type GQUser = {
  ...
  journalEntries?: Maybe<Array<GQJournalEntry>>;
...
export type GQUserResolvers<ContextType = any, ParentType extends GQResolversParentTypes['User'] = GQResolversParentTypes['User']> = {
  ...
  journalEntries?: Resolver<Maybe<Array<GQResolversTypes['JournalEntry']>>, ParentType, ContextType, RequireFields<GQUserJournalEntriesArgs, 'dayDate'>>;
