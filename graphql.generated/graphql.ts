...
export type GQUserResolvers<ContextType = any, ParentType extends GQResolversParentTypes['User'] = GQResolversParentTypes['User']> = {
  ...
  journalEntries?: Resolver<GQResolversTypes['JournalEntriesConnection'], ParentType, ContextType, RequireFields<GQUserJournalEntriesArgs, 'after' | 'before'>>;
