...
export type GQJournalEntryUnion = GQEvent | GQNextSet | GQSleep | GQTodo | GQTrip | GQWorkout;
...
export type GQJournalEntryResolvers<ContextType = any, ParentType extends GQResolversParentTypes['JournalEntry'] = GQResolversParentTypes['JournalEntry']> = {
  __resolveType: TypeResolveFn<'Event' | 'NextSet' | 'Sleep' | 'Todo' | 'Trip' | 'Workout', ParentType, ContextType>;
};
