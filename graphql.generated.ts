...
export type GQDiaryAgendaDayUserQuery = { user?: { __typename: 'User', id: string, name: string, email?: string | null, image: string, emailVerified?: boolean | null, timeZone?: string | null, dataSources?: Array<{ __typename: 'UserDataSource', id: string, name: string, paused?: boolean | null, createdAt: Date, updatedAt: Date, lastSyncedAt?: Date | null, lastSuccessfulAt?: Date | null, lastSuccessfulRuntime?: number | null, lastResult?: string | null, lastFailedAt?: Date | null, lastFailedRuntime?: number | null, lastAttemptedAt?: Date | null, lastError?: string | null, source: string, config?: unknown | null }> | null, exerciseSchedules?: Array<{ __typename: 'ExerciseSchedule', id: string, exerciseId: number, enabled: boolean, increment?: number | null, workingSets?: number | null, workingReps?: number | null, deloadFactor?: number | null, baseWeight?: number | null, snoozedUntil?: Date | null, frequency: { __typename: 'Duration', years?: number | null, months?: number | null, weeks?: number | null, days?: number | null, hours?: number | null, minutes?: number | null, seconds?: number | null } }> | null } | null };
